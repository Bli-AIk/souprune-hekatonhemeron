...
我记得我是写了个“坠落”状态。虽然本质上来说，“坠落”就是在静止的基础上加了个动画。但很可惜，我压根没把动画和状态本身分离。“静止”状态下仍然应该可以放任何动画，其他的也一样！但谁知道我当初是咋想的呢？这都是我们之后要规避的问题。

但总而言之，大概做状态机不算难事。倒也有一个难点――我这还是第一次正儿八经用 bevy――但不是第一次正儿八经学rust、看ECS，也不是正儿八经第一次用游戏引擎，做游戏开发！唯一“第一次”的就是拿 rust 在 bevy 用 ECS 开发 游戏... 多看看示例就好啦！大概吧。
